...
exports.updateTotalCartAmount = (req, res) => {
    ...
    req.sqreen.track('cart.total', { properties: { amount: req.session.totalCartAmount } });

    const currentlyHasCosts = req.session.shippingCostApplied;
    ...
    if (req.session.shippingCostApplied !== currentlyHasCosts) {
        req.sqreen.track('cart.shipping.switch', { properties: { hasCost: req.session.shippingCostApplied } });
    }
